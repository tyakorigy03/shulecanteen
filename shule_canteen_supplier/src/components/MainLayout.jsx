...
const MainLayout = () => {
    ...
    const navItems = [
        ...
        { path: '/menu', name: 'Catalog', icon: HiOutlineBookOpen },
        { path: '/orders', name: 'Orders', icon: HiOutlineShoppingCart },
        { path: '/deliveries', name: 'Deliveries', icon: HiOutlineTruck },
        { path: '/fleet', name: 'Fleet (Drivers)', icon: HiOutlineIdentification },
        { path: '/clients', name: 'Clients (Schools)', icon: HiOutlineLibrary },
        { path: '/account', name: 'Account', icon: HiOutlineUserCircle },
    ];
    ...
    return (
        <div
            ...
            style={{
                backgroundImage: 'linear-gradient(to right, #001f3f 0%, rgba(0, 31, 63, 0.9) 15%, rgba(0, 31, 63, 0.7) 100%), url("https:shulecantine.babyeyi.rw/supplier/preview.png")'
            }}
        >
            {/* Header */}
                ...
                <div className="flex items-center gap-2 lg:gap-4">
                    ...
                    <div className="flex items-center ps-1 lg:ps-2.5">
                        ...
                        <span className="self-center text-lg lg:text-xl font-black whitespace-nowrap text-white">
                            <span className="text-shuleamber">Shule</span><span className="hidden sm:inline">Cantine <span className="text-sm text-white/80 font-normal">(Supplier Portal)</span> </span><span className="sm:hidden">Cantine</span>
                        </span>
                    </div>
                </div>
                    ...
                    <div className="relative">
                        ...
                        >
                            ...
                            <div className="hidden sm:flex items-center gap-1.5 focus:outline-none">
                                <span className="text-navblue font-bold text-[13px] whitespace-nowrap">Munyarwanda Alice</span>
